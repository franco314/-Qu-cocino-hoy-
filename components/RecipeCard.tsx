...
import { Clock, ChefHat, Flame, AlertCircle, ChevronDown, ChevronUp, List, Heart } from 'lucide-react';
...
export const RecipeCard: React.FC<RecipeCardProps> = ({ recipe, index, isFavorite, onToggleFavorite }) => {
  ...
  const shareText = `🍳 ${recipe.title || 'Receta'}\n\n${recipe.description || ''}\n\n📝 Ingredientes: ${ingredients.join(', ')}\n\n✨ Descubrí más en la app "¿Qué cocino hoy?"`;
  ...
  return (
    ...
    >
      ...
      <div className="relative h-56 w-full bg-gray-100 overflow-hidden group-image">
        ...
        {/* Action Buttons (WhatsApp & Favorite) */}
        <div className="absolute top-4 right-4 z-20 flex gap-2">
            ...
            <button
                ...
                className="p-2.5 rounded-full bg-white/90 backdrop-blur-md hover:bg-white shadow-md transition-all duration-300 group focus:outline-none focus:ring-2 focus:ring-red-500"
                aria-label={isFavorite ? `Quitar ${recipe.title} de guardadas` : `Guardar receta ${recipe.title}`}
